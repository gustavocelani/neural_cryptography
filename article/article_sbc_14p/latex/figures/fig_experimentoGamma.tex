...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\tikzset{
			...
			block3/.style={draw, align=center, thick, rectangle, text width=4.5cm, minimum height=1.25cm},
		}
		...
		\node[block2, right=1cm of c]  (l)  {\textit{L = 5}};
		\node[block3, right=1cm of l]  (o1) {Função de Ativação B\\Regra de Aprendizado B};
