...
\begin{figure}[H]
	\centering
		\begin{tikzpicture}
			...
			\draw[-, thick] (sgn.east) -- (a.west);
			\draw[-, thick] (lin.east) -- (a.west);
			\draw[-, thick] (sgm.east) -- (a.west);
			\draw[-, thick] (tan.east) -- (a.west);
			
			\draw[-, thick] (sgn.east) -- (h.west);
			\draw[-, thick] (lin.east) -- (h.west);
			\draw[-, thick] (sgm.east) -- (h.west);
			\draw[-, thick] (tan.east) -- (h.west);
			
			\draw[-, thick] (sgn.east) -- (r.west);
			\draw[-, thick] (lin.east) -- (r.west);
			\draw[-, thick] (sgm.east) -- (r.west);
			\draw[-, thick] (tan.east) -- (r.west);
