...
plot_sigmoid_graphic()
{
	gnuplot -e "set terminal jpeg;
				...
				set title \"y = sigmoid(x)\";
				set key off;
				set grid;
				set border 1;
				set samples 400;
				plot exp(x)/(1 + exp(x)) with line linetype rgbcolor \"red\" linewidth 2" > sigmoid_preview.jpeg

	eog sigmoid_preview.jpeg
}
...
printf "\n"
printf "Usage:\n"
printf "./plot_sigmoid.sh raw\n"
printf "./plot_sigmoid.sh graphic\n"
printf "\n"
